...
export default function StudentDashboard() {
  const name = "Uday Gandhi";
  const shortName = "UG";
  const course = "Computer Engineering";
  const acd_year = 4;
  const sem = 7;
  const cgpa = 8.21;
  const enr_no = 2203031450007;
  const faculty_name = "Dr. Kapil Aggarwal";
  const fac_shrt_name = "KA";
  const fac_dept = "CSE core";
      ...
      <div className="flex">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              <Avatar className="w-20 h-20 mx-auto mb-4">
                ...
                <AvatarFallback className="text-lg">{shortName}</AvatarFallback>
              </Avatar>
            ...
            <Card className="mb-6">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{acd_year}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{enr_no}</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-6">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">Assigned Faculty</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex items-center space-x-3">
                  <Avatar className="w-10 h-10">
                    <AvatarImage src="/placeholder.svg?height=40&width=40" />
                    <AvatarFallback>{fac_shrt_name}</AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="font-medium text-sm">{faculty_name}</p>
                    <p className="text-xs text-gray-600">{fac_dept}</p>
                  </div>
                </div>
                <Button
                  variant="outline"
        ...
        <main className="flex-1 p-6 overflow-y-auto h-[calc(100vh-73px)]">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            {/* Visual Stats and Rank Distribution */}
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Faculty Assigned Tasks</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <Task/>
            ...
            {/* Smart Suggestions and Additional Features */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Smart Suggestions */}
              <Card>
                <CardHeader>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2 text-sm">
                          ...
                          <span>Graph Algorithms Video Series</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* Additional Features */}
              <div className="space-y-4">
                {/* Goals and Streak Tracker */}
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-base">Custom Goals</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">Daily Problem Goal</span>
                        <Badge variant="outline">2/3</Badge>
                      </div>
                      <Progress value={67} />

                      <div className="flex items-center justify-between">
                        <span className="text-sm">Weekly Contest Goal</span>
                  ...
                  <CardContent>
                    <div className="flex space-x-2">
                      <div className="text-center">
                        ...
                        <span className="text-xs">100 Problems</span>
                      </div>
                      <div className="text-center">
                        <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mb-1">
                          <Star className="w-6 h-6 text-green-600" />
                        </div>
                        <span className="text-xs">15 Day Streak</span>
                      </div>
                      <div className="text-center">
                  ...
                  <ScrollArea className="h-64">
                    <div className="space-y-3">
                      {[
                        {
                          name: faculty_name,
                          message: "Great work on the DP assignment!",
                          time: "2 min ago",
                          avatar:fac_shrt_name,
                          unread: true,
                        },
                        {
                          name: "Nevil Modi",
                          message: "Can anyone explain BFS implementation?",
                          time: "15 min ago",
                          avatar: "NM",
                          unread: false,
                        },
                        {
                          name: "Vraj Rathva",
                          message: "Can you help with binary trees?",
                          time: "1 hour ago",
                          avatar: "VR",
                          unread: false,
                        },
